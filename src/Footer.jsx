...
export default function Footer({ ...props }) {
    return (
        <>
            <ButtonGroup sx={{ display: 'block', position: 'fixed', width: 'min(160px, 100%)', left: '50%', bottom: '0', transform: 'translateX(-50%)', paddingBottom: '1.5rem' }} spacing={20} variant="ghost">
                <IconButton
                    as="a"
